...
public class ImageInception {

	/**
	 * @param inputFile
	 * @param inceptionGraph
	 * @param compGraphLabels
	 * @return
	 * @throws IOException
	 */
	public static Map<String, Object> analyze(byte[] imageBytes, byte[] graphDef, File compGraphLabels) throws IOException {
		List<String> labels = readAllLinesOrExit(compGraphLabels.toPath());
		Map<String, Object> results = new LinkedHashMap<>();
		try (Tensor<Float> image = constructAndExecuteGraphToNormalizeImage(imageBytes)) {
			float[] labelProbabilities = executeInceptionGraph(graphDef, image);
			results.put("labelProbabilities", labelProbabilities);
